...
# python3 translate.py --model="./model-text/checkpoint-5658" --mode="text" --input=./akkadian_test.txt --output="out5658longer.txt"
python3 translate.py --model="./model_visual_splitting/checkpoint-5658" --mode="pixels" --input=./akkadian_test.txt --output="vis_5658.txt"
