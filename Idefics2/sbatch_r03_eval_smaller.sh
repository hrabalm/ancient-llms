...
python3 translate.py --model="./model_visual_splitting_v5/checkpoint-1000" --mode="pixels" --input=./akkedian_ourtest.txt --output="visv5_small_1000.txt" --quantize --max-new-tokens=128 --batch-size=8
